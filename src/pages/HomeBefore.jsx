    ...
    <>
      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-6 justify-between">
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden w-full sm:w-80">
            <img className="h-60 w-full object-cover rounded-2xl" src="/techImg.png" alt="tech pic" />
            <div className="p-4">
              <h3 className="text-lg font-semibold leading-snug mb-2">
                Breaking into DevOps: <br /> Tips from Alumni
              </h3>
              <div className="flex items-center gap-3 mb-4">
                <img className="h-8 w-8 rounded-full object-cover" src="/profile.png" alt="profile" />
          ...
          {/* Card 2 */}
          <div className="bg-white rounded-2xl shadow-md overflow-hidden w-full sm:w-80">
            <img className="h-60 w-full object-cover rounded-2xl" src="/coding.png" alt="tech pic" />
            <div className="p-4">
              <h3 className="text-lg font-semibold leading-snug mb-2">
                The future of Full-<br /> Stack Development
              </h3>
              <div className="flex items-center gap-3 mb-4">
                <img className="h-8 w-8 rounded-full object-cover" src="/light.png" alt="profile" />
          ...
          {/* Card 3 */}
          <div className="bg-white rounded-2xl shadow-md overflow-hidden w-full sm:w-80">
            <img className="h-60 w-full object-cover rounded-2xl" src="/developer.png" alt="tech pic" />
            <div className="p-4">
              <h3 className="text-lg font-semibold leading-snug mb-2">
                Building Responsive UIs <br /> with Flexbox <br /> Tips from Alumni
              </h3>
              <div className="flex items-center gap-3 mb-4">
                <img className="h-8 w-8 rounded-full object-cover" src="/newpic.png" alt="profile" />
      ...
      <div className='bg-gray-200 p-10 rounded-md text-center'>
        ...
        <span className="flex items-center gap-4">
          <h1 className="text-2xl font-bold">We are Nurturing Africa's Tech Talent</h1>
          <button className="bg-orange-500 rounded-full p-2">
            <Link to="courses" className="text-white font-bold">Explore our Courses</Link>
          </button>
        </span>
      </div>
      ...
      <div className='bg-gray-200 p-6 rounded-md'>
        <span className='flex'>
          <p className='pr-4'>
            ...
            and Tech Leaders? Join Now
          </p>
          <a
            href="https://www.linkedin.com/search/results/all/?fetchDeterministicClustersOnly=true&heroEntityKey=urn%3Ali%3Aorganization%3A4801781&keywords=moringa%20school"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className='bg-orange-500 rounded-full p-1 text-white font-bold'>Join Now</button>
          </a>
        </span>
        <p>
          Be part of a growing community of 8000+ professionals working at leading<br />
