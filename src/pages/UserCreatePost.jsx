  ...
  return (
    <>
      ...
      <form
        ...
        className="max-w-3xl mx-auto bg-white p-4 sm:p-6 rounded-2xl shadow-md space-y-6 w-[95%] sm:w-[90%] md:w-full"
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between mt-6 gap-4">
          <button
            ...
            className="w-full sm:w-auto px-4 py-2 bg-gray-200 text-gray-800 rounded text-sm"
          >
            Discard
          </button>
          <button
            type="submit"
            className="w-full sm:w-auto px-6 py-2 bg-orange-600 text-white rounded hover:bg-orange-700 text-sm"
          >
            Post
          </button>
        </div>
