    ...
    <nav className="bg-white p-4">
      <div className="flex justify-between items-center">
        ...
        <div className="space-x-4 pr-12 flex items-center">
          ...
          <Link to="/tech/home" className="text-black-500 hover:text-gray-300">
            Category
          </Link>
          <Link to="/allchat" className="text-black-500 hover:text-gray-300">
            Chat
          </Link>
          <Link to="/create" className="text-black-500 hover:text-gray-300">
            Create
          </Link>
          <Link to="/panel" className="text-black-500 hover:text-gray-300">
            Panel
          </Link>
